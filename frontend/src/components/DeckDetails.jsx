...
// Importation des icônes ergonomiques
...
export default function DeckDetails() {
    ...
    return (
        ...
        {/* EN-TÊTE AVEC BOUTON DE NAVIGATION DIRECTE VERS LA RÉVISION */}
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border mb-8">
                ...
                <form onSubmit={handleAddCard} className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <div>
                            <label className="text-sm font-medium mb-1 block text-slate-600">Question (Recto)</label>
                            <Input 
                                value={newFront} 
                        ...
                        <div>
                            <label className="text-sm font-medium mb-1 block text-slate-600">Réponse (Verso - HTML accepté)</label>
                            <Textarea 
                                value={newBack} 
            ...
            <h2 className="text-xl font-bold mb-4 text-slate-900">Contenu du paquet</h2>
                            ...
                            {editingCardId === card._id ? (
                                <form onSubmit={handleUpdateCard} className="w-full flex flex-col gap-3">
                                    ...
                                    <div>
                                        ...
                                        <Textarea value={editBack} onChange={(e) => setEditBack(e.target.value)} rows={3} required />
                                    </div>
